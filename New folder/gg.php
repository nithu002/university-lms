...
<head>
    ...
    * {
    ...
    :root {
        --dark1: #34495E;
        --light1: linear-gradient(to right, #3399ff 0%, #66ffff 100%);
        --success1: linear-gradient(to right, #00ff00 0%, #00ffff 100%);
        --error1: linear-gradient(to right, #ff0000 0%, #ff00ff 100%);
        --warning1: linear-gradient(to right, #ffff00 52%, #66ffff 100%);
        --info1: linear-gradient(to right, #0066ff 0%, #66ffff 100%);
    }
    ...
    .notifications .toast {
        ...
        padding: 16px 17px;
        margin-bottom: 10px;
        background: linear-gradient(to top, #ccffff -6%, #99ccff 131%);
...
<body
            ...
            <div class="col s12">
                <div class="container">
                    <div class="section">
                        ...
                        <div class="buttons">
                            <button class="bt1" id="success">Success</button>
                            <button class="bt1" id="error">Error</button>
                            <button class="bt1" id="warning">Warning</button>
                            <button class="bt1" id="info">Info</button>
                        </div>
    ...
    const notifications = document.querySelector(".notifications"),
        buttons = document.querySelectorAll(".buttons .bt1");
    ...
    buttons.forEach(bt1 => {
        bt1.addEventListener("click", () => createToast(bt1.id));
    });
    </script>
</body>
