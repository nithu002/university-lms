...
<body
                        ...
                        <li><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i
                            ...
                            <div class="collapsible-body">
                                <ul class="collapsible" data-collapsible="accordion">
                                    <li class="active"><a class="active" href="../admission/transfer_in.php"><i
                                                class="material-icons">radio_button_unchecked</i>
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                <div class="col m6 s12 invoice-logo display-flex pt-1 push-m6">
                                                    <img src="assets/images/gallery/gs_logo.jpg" alt="logo" height="66"
                                                        width="200">
                                                </div>
                                                <div class="col m6 s12 pull-m6">
                                                    <h4 class="indigo-text">Transfer In Details</h4>
                                                </div>
                                            </div>
                                            ...
                                            <div class="section section-form-wizard">
                                                    ...
                                                    <ul class="stepper horizontal" id="horizStepper">
                                                        <li class="step active">
                                                            ...
                                                            <div class="step-content">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        ...
                                                                        <input type="text" class="validate"
                                                                            name="contact" id="phone-code" required="">
                                                                    </div>
                                                                    <div class="input-field col m4 s12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole" name="gender"
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        ...
                                                                        <input type="text" name="dob" class="datepicker"
                                                                            id="dob" class="validate" required="">
                                                                    </div>
                                                                    <div class="input-field col m4 s12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col m4 s12">
                                                                        ...
                                                                        <div class="input-field">
                                                                            <select class="error" id="crole"
                                                                                name="crole" data-error=".errorTxt6"
                                                                                required="">
                                                                                <option value="">Choose your profile
                                                                                </option>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole"
                                                                            name="persent_state" data-error=".errorTxt6"
                                                                            required="">
                                                                            <option value="">State *
                                                                            </option>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole"
                                                                            name="per_state" data-error=".errorTxt6"
                                                                            required="">
                                                                            <option value="">State *
                                                                            </option>
                                                                            <option value="sample1">sample1</option>
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole"
                                                                            name="per_district" data-error=".errorTxt6"
                                                                            required="">
                                                                            <option value="Select"> District *
                                                                            </option>
                                                                            <option value="sample">sample</option>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col m3 s12 mb-3">
                                                                        <button
                                                                            class="btn btn-light-indigo btn-block waves-effect waves-light next-step"
                                                                            type="submit">
                                                                            Next
                                                                            <i
                                                        ...
                                                        <li class="step">
                                                            ...
                                                            <div class="step-content">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole" name="Batch"
                                                                            data-error=".errorTxt6" required="">
                                                                            <option value="">Batch *
                                                                            </option>
                                                                            <option value="Sample1">Sample1</option>
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole" name="program:"
                                                                            data-error=".errorTxt6" required="">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole" name="session"
                                                                            data-error=".errorTxt6" required="">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole" name="semester"
                                                                            data-error=".errorTxt6" required="">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="error" id="crole" name="section"
                                                                            data-error=".errorTxt6" required="">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col m3 s12 mb-3">
                                                                        <button
                                                                            class="btn btn-light-indigo btn-block waves-effect waves-light previous-step">
                                                                            <i
                                                                                class="material-icons left">arrow_back</i>
                                                                            Prev
                                                                        </button>
                                                        ...
                                                        <li class="step">
                                                            <div class="step-title waves-effect">Step 4</div>
                                                            <div class="step-content">
                                                                <!--############TRANFER DETAILAS
                                                                #####################################-->
                                                                <h6>Add Transfer In</h6>
                                                                <div class="row ">
                                                                    <div class="input-field col m6 s6">
                                                                        <label for="transfer_id">
                                                                            Transfer ID *</label>
                                                                        <input type="text" class="validate"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div id="dynamic_upload_transfer">
                                                ...
                                                <!--THIS IS FORM FILE ##### FORMATE DONT DELETE THAT-->
                                                <div class="row">
                                                    <div class="col s12">
                                                ...
                                                <!--END THIS IS FORM FILE ##### FORMATE DONT DELETE THAT-->
                                            </div>
                                    ...
                                    <div class="card invoice-action-wrapper mb-10">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="row invoice-action-btn">
                                                ...
                                                <div class="col s6 preview">
                                                    <a class="btn btn-light-indigo btn-block waves-effect waves-light"
                                                        ...
                                                        <span class="responsive-text">Back</span>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="invoice-action-btn">
                                                <a
                                                    class="btn waves-effect waves-light gradient-45deg-light-blue-cyan  z-depth-4 display-flex align-items-center justify-content-center">
                                                    <i class="material-icons mr-3">send</i>
                                                    <span class="responsive-text">Submit</span>
                                                </a>
                                            </div>
    ...
    $(document).ready(function() {
        ...
        $('#added').click(function() {
            ...
            $('#dynamic_upload').append('<div class="row section" id="row' + i +
                '"> <div class="input-field col m4 s6"><label for="title">Title *</label> <input type="text" class="validate" id="title" name="title" required=""></div><div class="input-field col m7 s6"> <p>Document</p> <input type="file" id="input-file-max-fs" required="" name="documant_file" class="validate" data-max-file-size="2M"> </div> <td><button type="button" name="add" class="mb-6 btn-floating waves-effect waves-light gradient-45deg-red-pink btn_tremove" id="' +
    ...
    $(document).ready(function() {
        ...
        $('#transfer').click(function() {
            i++;
            $('#dynamic_upload_transfer').append('<div class="row section" id="row' + i +
                '"> <div class="input-field col m4 s6"><label for="title">Title *</label> <input type="text" class="validate" id="title" name="title" required=""></div><div class="input-field col m7 s6"> <p>Document</p> <input type="file" id="input-file-max-fs" required="" name="documant_file" class="validate" data-max-file-size="2M"> </div> <td><button type="button" name="add" class="mb-6 btn-floating waves-effect waves-light gradient-45deg-red-pink btn_tremove" id="' +
                i + '"><i class="material-icons">clear</i></button></td></div></div>');
        });
        $(document).on('click', '.btn_tremove', function() {
