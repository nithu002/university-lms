            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../students/student_notes.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Edit Student Notes</h5>
                                                            </blockquote>
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    <label for="title">Title <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <input type="text" class="validate" id="title"
                                                                        name="title" required="">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                    ...
                                                    <div class="col s4">
                                                        ...
                                                        <div id="modal2" class="modal col s4">
                                                            <div class="modal-content">
                                                                <blockquote>
                                                                    <h5 class="indigo-text">View Student Note</h5>
                                                                </blockquote>
                                                                <table>
                                                                    &nbsp <b class="indigo-text">Title:</b>&nbsp
                                                                    &nbsp
                                                                    Title
                                                                    <br>
                                                                    <br>
                                                                    &nbsp <b class="indigo-text">Student ID:</b>&nbsp
                                                                    &nbspStudent_ID
                                                                    <br>
                                                                    <br>
                                                                    &nbsp <b class="indigo-text">Note:</b>&nbsp
                                                                    &nbspNote
                                                                    <br>
                                                                    <br>
                                                                    &nbsp <b class="indigo-text">Status:</b>&nbsp
                                                                    &nbsp<span class="chip green lighten-5">
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Student Note List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="users-list-datatable" class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="#modal2"
                                                                            class="modal-trigger button8 button3"><i
                                                                                class="material-icons center"
                                                                                style="font-size: 18px">remove_red_eye</i>&nbsp
                                                                        </a>
                                                                        <a class=" modal-trigger button8 button3 "
                                                                            href="#modal1"><i
                                                                                class="material-icons center"
                                                                                style="font-size: 18px">edit</i>&nbsp</a>
                                                                        <a class=" modal-trigger button8 button10"
                                                                            href=""><i class="material-icons center"
                                                                                style="font-size: 18px">file_download</i>&nbsp</a>
                                ...
                                <div class="col xl4 m4 s12">
                                    <div class="card invoice-action-wrapper mb-10">
                                        ...
                                        <form class="formValidate" id="formValidate" method="POST" action="">
                                            <div class="card-content" id="view-validations">

                                                <div id="cards-extended">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Create Student Note</h5>
                                                    </blockquote>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col s12">
                                                        <label for="student">Student <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <div class="input-field">
                                                            <select class="error" id="student" name="student"
                                                    ...
                                                    <div class="input-field col s12">
                                                        <label for="title1">Title <span
                                                                class="#00c853 green-text">*</span> </label>
                                                        <input type="text" class="validate" data-error=".errorTxt2"
                                                            name="title" id="title1" required>
                                                        <small class="errorTxt2"></small>
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <textarea id="textarea" name="note"
                                                            class="materialize-textarea validate"
                                                            data-error=".errorTxt3" data-length="120"
                                                            required=""></textarea>
                                                        <label for="textarea">Note <span
                                                                class="#00c853 green-text">*</span></label>
                                                    ...
                                                    <div id="file-input">
                                                        <div id="view-file-input">
                                                            <div class="file-field input-field col s12">
                                                                ...
                                                                <div class="file-path-wrapper">
                                                                    <input class="file-path validate"
                                                                        data-error=".errorTxt4" type="text">
