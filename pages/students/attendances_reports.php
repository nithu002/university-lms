            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../students/attendances_reports.php"><i
                                    class="material-icons">radio_button_unchecked</i>
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li ><a href="../academic/enroll_course.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                <span data-i18n="Enroll Course">Enroll Course</span>
                            </a>
                        </li>
                        <li><a href="../academic/class_routines.php"><i class="material-icons">radio_button_unchecked</i>
                                ...
                                <div id="validations" class="card card-tabs">
                                    ...
                                    <div class="card-content">
                                        <div class="card-title">
                                            <blockquote>
                                                <h5 class="indigo-text">Student Attendance</h5>
                                            </blockquote>
                                        </div>
                                        <div class="">
                                            <a href="attendances_reports.php"
                                            ...
                                            <form class="formValidate" id="formValidate" method="POST" action="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col s2">
                                                        ...
                                                        <div class="input-field">
                                                            <select class="error" id="month" name="month"
                                                    ...
                                                    <div class="col s2">
                                                        ...
                                                        <div class="input-field">
                                                            <select class="error" id="year" name="year"
                                                    ...
                                                    <div class="col s2">
                                                        ...
                                                        <div class="input-field">
                                                            <button type="submit" name="submit"
                                                                ...
                                                                <span class="hide-on-small-only">Search</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
