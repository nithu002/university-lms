            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../academic/programs.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Edit Program</h5>
                                                            </blockquote>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <input type="text" class="validate" id="shortcode"
                                                                        name="shortcode">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Program List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                        ...
                                        <form class="formValidate" id="formValidate" method="POST" action="">
                                            <div class="card-content">
                                                ...
                                                <div id="cards-extended">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Create Program</h5>
                                                    </blockquote>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        <label for="faculty">Faculty <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <br>
                                                        <select data-placeholder="" data-error=".errorTxt1"
                                                            name="faculty" required id="faculty">
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        ...
                                                        <input type="text" class="validate" id="shortcode1"
                                                            name="shortcode">
                                                    </div>
                                                </div>
                                                <div class="row">
