            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../academic/sections.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Edit Section</h5>
                                                            </blockquote>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <label>
                                                                    <b>Assign Program<span
                                                                            class="#00c853 green-text">*</span>
                                                                    </b>
                                                                </label>
                                                                <br>
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Section List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="users-list-datatable" class="table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th></th>
                                                                    <th style="width: 15%">Program > Semester</th>
                                                                    <th></th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><span class="chip #84ffff cyan accent-1"><span
                                                                                class="#e0f7fa cyan-text">Program >
                                                                                Semester</span>
                                                                        </span>
                                                                    </td>
                                                                    <td></td>
                                        ...
                                        <form class="formValidate" id="formValidate" method="POST" action="">
                                            <div class="card-content">
                                                ...
                                                <div id="cards-extended">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Create Section</h5>
                                                    </blockquote>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        ...
                                                        <input type="text" class="validate" id="title1" name="title"
                                                            data-error=".errorTxt1" required=""> <small
                                                            class="errorTxt1"></small>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <br>
                                                <div class="row">
                                                    <p class="chip #84ffff cyan accent-1"><b
                                                            class="light-blue-text">Sample</b>
                                                    </p>
