            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../academic/course.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <blockquote>
                                                <h5 class="indigo-text">Course List</h5>
                                            </blockquote>
                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col s3">
                                                                    ...
                                                                    <div class="input-field">
                                                                        <select class="error" id="faculty"
                                                                            name="faculty" data-error=".errorTxt1"
                                                                            required="">
                                                                ...
                                                                <div class="col s3">
                                                                    <label for="program">
                                                                        Program <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <div class="input-field">
                                                                        <select class="error" id="program"
                                                                            name="program" data-error=".errorTxt2"
                                                                            required="">
                                                                            <option value="">All</option>
                                                                            <option value="1">Manager</option>
                                                                ...
                                                                <div class="col s2">
                                                                    <label for="course_type">
                                                                        Course Type <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <div class="input-field">
                                                                        <select class="error" id="course_type"
                                                                            name="course_type" data-error=".errorTxt3"
                                                                            required="">
                                                                            <option value="">All</option>
                                                                            <option value="1">Manager</option>
                                                                ...
                                                                <div class="col s2">
                                                                    <label for="class_type">
                                                                        Class Type <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <div class="input-field">
                                                                        <select class="error" id="class_type"
                                                                            name="class_type" data-error=".errorTxt4"
                                                                            required="">
                                                                            <option value="">All</option>
                                                                            <option value="1">Manager</option>
                                                                ...
                                                                <div class="col s2">
                                                                    ...
                                                                    <div class="input-field">
                                                                        <button type="submit" name="submit"
                                                                            ...
                                                                            <span
                                                                                class="responsive-text">Filter</span></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                        ...
                                        <div class="row">
                                            ...
                                            <ul type="none">
                                                <li>
                                                    <a class="button91 button9 tooltip" id="btn" onclick="copyText()"><i
                                                    ...
                                                    <a href="javascript:void(0);" class="button91 button9 tooltip"
                                        ...
                                        <!-- ########################### EDIT MODEL PAGE WITH COURSE ##########################################-->
                                        <div id="view-example">
                                            <form action="" method="POST">
                                                <div class="row">
                                                    <section class="invoice-edit-wrapper section">
                                                        <div class="col s12">
                                                            <div id="modal1" class="modal col xl9 m8 s12">
                                                                <div class="modal-content">
                                                                    <blockquote>
                                                                        <h5 class="indigo-text">Edit Course</h5>
                                                                    </blockquote>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="input-field col  s4">
                                                                            <label for="credit_hours">Credit
                                                                                Hours <span
                                                                                    class="#00c853 green-text">*</span></label>
                                                                            <input type="text" class="validate"
                                                                                name="credit_hours" id="phone-code"
                                                                                required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                    ...
                                                                    <br>
                                                                    <div class="row">
                                                                        <span class="chip #84ffff cyan accent-1"><span
                                                                                class="light-blue-text">Sample</span>
                                                                        </span>
                                                                        <div class="input-field col m12 s12">
                                                                            <label>
                                                                                <input type="checkbox" name=""
                                                                                    checked="checked" required="" />
                                                                                <span>Testing sample</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    <br>
                                        ...
                                        <!-- ######## END ################### EDIT MODEL PAGE WITH COURSE ##########################################-->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class=" modal-trigger button8 button3 "
                                                                    href="#modal1"><i class="material-icons center"
