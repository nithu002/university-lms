...
<body
            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../academic/sessions.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                        ...
                        <li><a href="../academic/enroll_course.php"><i class="material-icons">radio_button_unchecked</i>
                                <span data-i18n="Course">Enroll Course</span>
                            </a>
                        </li>
                        <li><a href="../academic/enroll_course.php"><i class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Edit Session</h5>
                                                            </blockquote>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <input type="text" name="start_date"
                                                                        class="datepicker validate" id="start_date"
                                                                        required="">
                                                                </div>
                                                                ...
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <input type="text" name="end_date"
                                                                        class="datepicker validate" id="end_date"
                                                                        required="">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <label><b>Assign Program <span
                                                                            class="#00c853 green-text">*</span></b></label>
                                                                <div class="input-field col m12 s12">
                                                                    <label>
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Session List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                        ...
                                        <form class="formValidate" id="formValidate" method="POST" action="">
                                            <div class="card-content">
                                                ...
                                                <div id="cards-extended">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Create Session</h5>
                                                    </blockquote>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        <label for="title1">Title <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <input type="text" class="validate" id="title1" name="title"
                                                            required="" data-error=".errorTxt1">
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        <label for="date0">Start Date <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <input type="text" class="datepicker validate" id="date0"
                                                            name="start_date" required data-error=".errorTxt2">
                                                        <small class="errorTxt2"></small>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        <label for="date1">End Date <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <input type="text" class="datepicker validate" id="date1"
                                                            name="end_date" required data-error=".errorTxt3">
                                                        <small class="errorTxt3"></small>

                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <label>Assign Program <span
                                                            class="#00c853 green-text">*</span></label>
                                                    <div class="input-field col m12 s12">
                                                        <label>
    ...
    <!-- #################### CHECKBOX JS ########################-->
    <script src="../../assets/js/scripts/my_add/checkbox.js"></script>
    <!-- #################### CHECKBOX JS ########################-->
...
if (isset($_POST['delete'])) {
    ...
    function copyText() {
        ...
        btnText.innerText = "Make Current"
    }
    </script>
