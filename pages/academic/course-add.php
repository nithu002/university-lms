...
<body
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <blockquote>
                                                <h5 class="indigo-text">Add Course</h5>
                                            </blockquote>
                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col  s4">
                                                                        ...
                                                                        <input type="text" class="validate" id="code"
                                                                            data-error=".errorTxt2" name="code"
                                                                            required>
                                                                    ...
                                                                    <div class="input-field col  s4">
                                                                        ...
                                                                        <input type="text" class="validate"
                                                                            data-error=".errorTxt3" name="credit_hours"
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <div class="invoice-action-btn">
                                                                            ...
                                                                            <button type="submit"
                                                                                ...
                                                                                id="info">
                                                                                <span
                                                                                    class="responsive-text">Save</span>
                                                                            </button>
                                                                            <!-- </div>  -->
                                                                            <!-- passing a parameter -->
    ...
    $("#formValidate").validate({
        ...
        messages: {
            ...
            credit_hours: {
                required: "Please Select Credit Hours"
            },
            course_type: {
