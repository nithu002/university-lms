            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../academic/faculties.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Edit Faculty</h5>
                                                            </blockquote>
                                                            <div class="row">
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Faculty List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card invoice-action-wrapper mb-10">
                                        ...
                                        <form class="formValidate" id="formValidate" method="POST" action="">
                                            <div class="card-content">
                                                ...
                                                <div id="validations">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Create Faculty</h5>
                                                    </blockquote>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        <label for="title">Title <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <input type="text" data-error=".errorTxt1" class="validate"
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        ...
                                                        <input type="text" data-error=".errorTxt2" class="validate"
