            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../academic/batches.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Edit Batch</h5>
                                                            </blockquote>
                                                            <div class="row">
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Batch List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="users-list-datatable" class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td> <a class=" modal-trigger button8 button3 "
                                                                            href="#modal1"><i
                                        ...
                                        <form class="formValidate" id="formValidate" method="POST" action="">
                                            <div class="card-content">
                                                ...
                                                <div id="cards-extended">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Create Batch</h5>
                                                    </blockquote>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        <label for="date1">Start Date <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <input type="text" class="datepicker validate" id="date1"
                                                            data-error=".errorTxt2" name="start_date" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col m12 s12">
                                                        <label>
                                                            <input type="checkbox" name="" data-error=".errorTxt1" />
                                                            <span>Example</span>
                                                        </label>
