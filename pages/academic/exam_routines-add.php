...
<body
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div id="validations" class="card card-tabs">
                                    <div class="card-content">
                                        <div id="view-validations">
                                            <form class="formValidate" id="formValidate1" method="POST" action="">
                                                <div class="row">
                                                    <div class="col  s3">
                                                        <label for="course">Course <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <div class="input-field">
                                                            <select class="error" id="course" name="course"
                                                                data-error=".errorTxt7" required="">
                                                                <option value="">Select</option>
                                                                <option value="1">Manager</option>
                                                            </select>
                                                    ...
                                                    <div class="input-field col  s3">
                                                        <label for="teacher">Teacher <span
                                                                class="#00c853 green-text">*</span></label>
                                                        &nbsp;
                                                        <input type="text" class="validate" id="teacher" name="teacher"
                                                            data-error=".errorTxt8" required="">
                                                        <small class="errorTxt8"></small>
                                                    </div>
                                                    <div class="input-field col  s3">
                                                        <label for="room">Rooms <span
                                                                class="#00c853 green-text">*</span></label>
                                                        &nbsp;
                                                        <input type="text" class="validate" id="room" name="room"
                                                    ...
                                                    <div class="input-field col s3">
                                                        <label for="date">Date <span
                                                                class="#00c853 green-text">*</span></label>
                                                        &nbsp;
                                                        <input type="text" class=" datepicker validate error" id="date"
                                                            name="date" data-error=".errorTxt10" required="">
                                                ...
                                                <div class="row">
                                                    <div class="input-field col s3">
                                                        <label for="time_from">Time
                                                            From <span class="#304ffe indigo-text">
                                                                *</span></label>
                                                        &nbsp;
                                                        <input type="text" class=" timepicker error" id="time_from"
                                                            name="time_from" data-error=".errorTxt11" required="">

                                                        <small class="errorTxt11"></small>
                                                    </div>
                                                    <div class="input-field col s3">
                                                        <label for="time_to">Time To <span class="#304ffe indigo-text">
                                                                *</span></label>
                                                        &nbsp;
                                                        <input type="text" class=" timepicker error" id="time_to"
                                                            name="time_to" data-error=".errorTxt12" required="">
                                                    ...
                                                    <div class="col s2">
                                                        ...
                                                        <div class="input-field">
                                                            <button type="submit" name="submit"
                                                                class="btn waves-effect waves-light gradient-45deg-light-blue-cyan z-depth-4">
                                                                <span class="responsive-text">Save</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
    ...
    <script src="../../assets/js/scripts/my_add/validate_js/exam-add.js"></script>
