            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../academic/semesters.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Edit Semester</h5>
                                                            </blockquote>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <select data-placeholder="" data-error=".errorTxt6"
                                                                        ...
                                                                        <option value="6th_year">6th Year</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Semester List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                        ...
                                        <form class="formValidate" id="formValidate" method="POST" action="">
                                            <div class="card-content">
                                                ...
                                                <div id="cards-extended">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Create Semester</h5>
                                                    </blockquote>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m12 s12">
                                                        <label for="year">Year <span
                                                                class="#00c853 green-text">*</span></label>
                                                        <br>
                                                        <select data-error=".errorTxt2" name="status" class="" id="year"
                                                            required>
