            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class=""><a class="" href="../students/student_alumni.php"><i
                                    class="material-icons">radio_button_unchecked</i>
            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../academic/class_rooms.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Add Class Room</h5>
                                                            </blockquote>
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    <label for="room">Room No <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <input type="text" class="validate"
                                                                        data-error=".errorTxt1" id="room" name="room"
                                                                        required="">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <label for="building">Building / Floor <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <input type="text" name="building"
                                                                        data-error=".errorTxt2" class="validate"
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <label for="phonecode">Capacity <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <input type="text" name="capacity"
                                                                        data-error=".errorTxt3" class="validate"
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <input type="text" name="type"
                                                                        data-error=".errorTxt4" class="validate"
                                                                        id="type" required="">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a href="#!"
                                                                    class="modal-action modal-close waves-effect  btn-light-red btn-flat">Close</a>
                                                                <button type="submit" name=""
                                                                    class="btn waves-effect waves-light #84ffff cyan accent-1 btn-flat">Add</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <section class="invoice-edit-wrapper section">
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal2" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text"> Edit Class Room</h5>
                                                            </blockquote>
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    <label for="room1">Room No <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <input type="text" class="validate"
                                                                        data-error=".errorTxt1" id="room1" name="room"
                                                                        required="">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <label for="building1">Building / Floor <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <input type="text" name="building"
                                                                        data-error=".errorTxt2" class="validate"
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    ...
                                                                    <label for="phonecode1">Capacity <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <input type="text" name="capacity"
                                                                        data-error=".errorTxt3" class="validate"
                                                                        id="phone-code" required="">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m12 s12">
                                                                    <label>Select Status <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <br>
                                                                    <select data-placeholder="" data-error=".errorTxt6"
                                                            ...
                                                            <div class="modal-footer">
                                                                <a href="#!"
                                                                    class="modal-action modal-close waves-effect  btn-light-red btn-flat">Close</a>
                                                                <button type="submit" name=""
                                                                    class="btn waves-effect  #69f0ae green accent-2 btn-flat">Update</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                            </section>
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-title">
                                            <blockquote>
                                                <h5 class="indigo-text">Class Room List</h5>
                                            </blockquote>
                                        </div>
                                        <div class="row">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td>
                                                                    <div class="">
                                                                        <a href="#modal1"
                                                                            class="modal-trigger btn waves-effect waves-light gradient-45deg-light-blue-cyan border-round z-depth-4">
                                                                            <i class="material-icons">add</i>
                                                                            <span class="responsive-text">New</span>
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="">
                                                                        <a href="class_rooms.php"
                                                ...
                                                <table id="users-list-datatable" class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 20%">Building/Floor</th>
                                                            <th style="width: 15%">Capacity</th>
                                                            <th style="width: 15%">Type</th>
                                                            <th style="width: 15%">Status</th>
                                                            <th style="width: 20% align-center">Action</th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#modal2" class="modal-trigger"> <button
                                                                        class=" button91 button3"><i
                                                                            class="material-icons center"
                                                                            style="font-size: 18px">edit</i>&nbsp
                                                                    </button></a>
                                                                ...
                                                                <table id="dataTable" class="table">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th style="width: 15%">Room</th>
                                                                            <th style="width: 20%">Building/Floor
                                                                            </th>
                                                                            <th style="width: 15%">Capacity</th>
                                                                            <th style="width: 15%">Type</th>
                                                                            <th style="width: 15%">Status</th>
