                                    ...
                                    <div class="col s12">
                                        <div class="card z-depth-1">
                                            <div class="card-content">
                                                <blockquote>
                                                    <h5 class="indigo-text">Edit Enroll Course</h5>
                                                </blockquote>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="">
                                                                                            <a class="btn btn-light-indigo btn-block waves-effect waves-light"
                                                                                                ...
                                                                                                <span
                                                                                                    class="responsive-text">Preview</span>
                                                                                            </a>
                                                                                        </div>
                                                                                    </td>
                                                                                    <td>
                                                                ...
                                                                <div class="col s6">
                                                                    ...
                                                                    <div class="input-field">
                                                                        <select class="error" id="faculty"
                                                                            data-error=".errorTxt1" name="faculty"
                                                                            required="">
                                                                ...
                                                                <div class="col s6">
                                                                    ...
                                                                    <div class="input-field">
                                                                        <select class="error" id="program"
                                                                            data-error=".errorTxt2" name="program"
                                                                            required="">
                                                                            <option value="">All</option>
                                                                            <option value="1">Manager</option>
                                                                ...
                                                                <div class="col s6">
                                                                    <label for="semester">
                                                                        Semester <span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <div class="input-field">
                                                                        <select class="error" id="semester"
                                                                            data-error=".errorTxt3" name="semester"
                                                                            required="">
                                                                            <option value="">All</option>
                                                                            <option value="1">Manager</option>
                                                                ...
                                                                <div class="col s6">
                                                                    <label for="section">
                                                                        Section<span
                                                                            class="#00c853 green-text">*</span></label>
                                                                    <div class="input-field">
                                                                        <select class="error" id="section"
                                                                            data-error=".errorTxt4" name="section"
                                                                            required="">
                                                                            <option value="">All</option>
                                                                            <option value="1">Manager</option>
