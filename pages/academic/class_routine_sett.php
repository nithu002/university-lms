                        ...
                        <li class="active"><a class="collapsible-header waves-effect waves-cyan"
                            ...
                            <div class="collapsible-body">
                                <ul class="collapsible" data-collapsible="accordion">
                                    ...
                                    <li class="active"><a class="active" href="../academic/class_routine_sett.php"><i
                                                class="material-icons">radio_button_unchecked</i>
                                    ...
                                    <div class="col s12">
                                        <div class="card z-depth-1">
                                            <div class="card-content">
                                                <blockquote>
                                                    <h5 class="indigo-text">Class Routine Settings</h5>
                                                </blockquote>
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col s6">
                                                                    ...
                                                                    <input type="text" class="error validate" id="width"
                                                                        ...
                                                                        placeholder="1000px" value="1000px" required="">
