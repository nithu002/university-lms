...
<head>
    ...
    <title>App Invoice-List | Materialize - Material Design Admin Template</title>
    ...
    .button1 {
        background: linear-gradient(to right, #6699ff 0%, #cc33ff 100%);
    }

    .button2 {
        background: linear-gradient(to top left, #ffcc66 0%, #ff3399 100%);
    }

    .button3 {
        background: linear-gradient(to top left, #6666ff 0%, #00ffff 100%);
    }
    ...
    .button7 {
        background: linear-gradient(to right, #ff3399 0%, #ff0000 100%);
    }
    </style>
</head>
<!-- END: Head-->
                                        ...
                                        <table id="users-list-datatable" class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 20%">Transfer ID</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Note</td>
                                                    <td>
                                                        <a href="edit-transfer.php"> <button class="button8 button3"><i
