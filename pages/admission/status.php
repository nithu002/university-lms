            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li class="active"><a class="active" href="../admission/status.php">
                                <i class="material-icons">radio_button_unchecked</i>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col m12 s12">
                                                                        ...
                                                                        <div class="input-field">
                                                                            <select class="error" id="status"
                                                                                name="status" data-error=".errorTxt1"
                                                                                required="">
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Status Type List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                            ...
                                            <form class="formValidate" id="formValidate" method="POST" action="">
                                                <div class="card-content">
                                                    ...
                                                    <div id="cards-extended">
                                                        <blockquote>
                                                            <h5 class="indigo-text">Create Status Type</h5>
                                                        </blockquote>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col s3.5 offset-s0"><span class="flow-text">
                                                                <div class="">
                                                                    <a href="status.php"
                                                                        class="btn btn-light-purple btn-block waves-effect waves-light border-round z-depth-4">
