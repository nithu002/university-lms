...
<body
                                                ...
                                                <div class="card-content pb-0">
                                                    <ul class="stepper horizontal" id="horizStepper">
                                                        <li class="step active">
                                                            <div class="step-title waves-effect">Basic Info</div>
                                                            <div class="step-content">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="max-length browser-default error"
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        ...
                                                                        <input type="text" name="dob"
                                                                            class="datepicker validate" id="dob"
                                                                            required="">
                                                                    </div>
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="max-length browser-default error"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="max-length browser-default error"
                                                                            ...
                                                                            data-error=".errorTxt6" name="persent_state"
                                                                            required>
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="max-length browser-default error"
                                                                            ...
                                                                            data-error=".errorTxt6"
                                                                            name="persent_district" required>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="max-length browser-default error"
                                                                            data-placeholder="District *"
                                                                            data-error=".errorTxt6" name="per_district"
                                                                            required>
                                                                            <option value="">
                                                                            </option>
                                                                            <option value="sample">sample</option>
                                                        ...
                                                        <!--END 1 CONTENT -->
                                                        <li class="step">
                                                            <div class="step-title waves-effect">Education
                                                                Info</div>
                                                            <div class="step-content">
                                                                <fieldset>
                                                                    <div class="row">
                                                        ...
                                                        <li class="step">
                                                            <div class="step-title waves-effect">Documents</div>
                                                            <div class="step-content">
                                                                <!--############FILE UPLOADE#####################################-->
                                                                <fieldset>
                                                        ...
                                                        <li class="step">
                                                            <div class="step-title waves-effect">Transfer Info</div>
                                                            <div class="step-content">
                                                                <!--############TRANFER DETAILAS
                                                                #####################################-->
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col m12 s6">
                                                                        <textarea id="textarea1" name="transfer_note"
                                    ...
                                    <div class="card invoice-action-wrapper mb-10">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="invoice-action-btn">
                                                <div class="buttons">
                                                    <a class="btn waves-effect waves-light gradient-45deg-light-blue-cyan  z-depth-4 display-flex align-items-center justify-content-center bt1"
                                                        id="info">
    ...
    //TEXTAREA NUMBER COUNT J.S CODE
    $(document).ready(function() {
