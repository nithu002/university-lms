                                ...
                                <div class="card-content">
                                    <div class="row">
                                        <form>
                                            ...
                                            <div class="col s12 m6 l3">
                                                <label for="users-list-role">Filter </label>
                                                <div class="input-field">
                                                    <button
                                                        ...
                                                        <i class="material-icons">filter_list</i><span
                                                            class="hide-on-small-only">Filter</span></button>
                                                            ...
                                                            <td>
                                                                <div class="">
                                                                    <a href="add-student.php"
                                                                        ...
                                                                        <span class="hide-on-small-only">New</span>
                                                                    </a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                            ...
                                            <table id="users-list-datatable" class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>300</td>
                                                        <td><a href="view-student.php">dean3004</a>
                                                        </td>
                                                            ...
                                                            <ul type="none">
                                                                <li>
                                                                    <a href="" class="button button1"><i
                                                                            ...
                                                                            style="font-size: 20px">picture_as_pdf</i>&nbsp
                                                                        password</a>
                                                                    <a href="" class="button0 button2"><i
                                                                            class="material-icons"
                                                                            style="font-size: 20px">mail</i>&nbsp
                                                                        password</a>
                                                                </li>
                                                                <li>
                                                                    <a href="view-student.php"
                                                                        class="button8 button3"><i
                                                                    ...
                                                                    <a href="" class="button8 button5"><i
                                                                            class="material-icons center"
                                                                            style="font-size: 18px">person_outline
                                                                        </i>&nbsp
                                                                    </a>
                                                                    <a href="" class="button8 button3"><i
                                                                            class="material-icons center"
                                                                            style="font-size: 18px">key</i>&nbsp
                                                                    </a>
...
if (isset($_POST['delete'])) {
    ...
    swal({
        ...
        if (willDelete) {
            swal("Successfuly! That details  has been deleted!", {
                icon: "success",
            });
        } else {
