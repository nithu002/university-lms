                        ...
                        <li class="active"><a class="collapsible-header waves-effect waves-cyan"
                            ...
                            <div class="collapsible-body">
                                <ul class="collapsible" data-collapsible="accordion">
                                    <li><a class="active" href="../admission/transfer_in.php"><i
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <h4 class="indigo-text">Edit Student</h4>
                                                </div>
                                            </div>
                                            ...
                                            <div class="step-content">
                                                <!--############TRANFER DETAILAS
                                                                #####################################-->
                                                <h6>Edit Transfer In</h6>
                                                <div class="row ">
                                                    <div class="input-field col m6 s6">
                                                        <label for="student_id">
                                                            Student ID *</label>
                                                        <input type="text" class="validate" id="student_id"
                                                            name="student_id" required="">
                                                    </div>
                                                    <div class="input-field col m6 s6">
                                                        <label for="transfer_id">
                                                            Transfer ID *</label>
                                                        <input type="text" class="validate" id="transfer_id"
                                                            name="transfer_id" required="">
                                                    </div>
                                                </div>
                                                <div class="row ">
                                                    <div class="input-field col m6 s6">
                                                        ...
                                                        <input type="text" class="validate" id="university_name"
                                                ...
                                                <!--########END #TRANFER DETAIES #####################################-->
                                                <div class="row">
                                                    <input type="text" placeholder="" maxlength="8" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card invoice-action-wrapper mb-10">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="invoice-action-btn">
                                                ...
                                                <a type="submit"
                                                    class="btn waves-effect waves-light gradient-45deg-green-teal  z-depth-4 display-flex align-items-center justify-content-center bt1"
                                                    id="info">
