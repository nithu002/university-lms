                        ...
                        <li><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i
                            ...
                            <div class="collapsible-body">
                                <ul class="collapsible" data-collapsible="accordion">
                                    ...
                                    <li class="active"><a class="active" href="../admission/transfer_out.php">
                                            <i class="material-icons">radio_button_unchecked</i>
                        ...
                        <div class="users-list-table">
                            <div class="card">
                                <div class="card-content">
                                    <blockquote>
                                        <h5 class="indigo-text">Transfer Out List</h5>
                                    </blockquote>
                                    <div class="row">
                                        ...
                                        <table id="users-list-datatable" class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Note</td>
                                                    <td>
                                                        <a href="../page_maintenance/page-maintenance.html"> <button
                                                                class="button8 button3"><i class="material-icons center"
