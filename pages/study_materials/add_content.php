...
<head>
    ...
    <title>System | Study Material</title>
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"
                            ...
                            <div class="collapsible-body">
                                <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                                    ...
                                    <li class="active"><a class="active" href="../study_materials/content_list.php"><i
                                                class="material-icons">radio_button_unchecked</i>
                                            <span data-i18n="Content">Content List</span>
                                        </a>
                                    </li>
                                ...
                                <div class="col12">
                                    ...
                                    <div class="card">
                                        <div class="card-content px-36">
                                            ...
                                            <!-- header section -->
                                            <div class="step-title waves-effect"><h5>Add Content</h5></div>
                                            ...
                                            <div class="section section-form-wizard">
                                                <div class="card-content pb-0">
                                                                <div class="">
                                                                    ...
                                                                    <a href="add_content.php" class="btn waves-effect waves-light purple border-round z-depth-4">
                                                    ...
                                                    <ul class="stepper horizontal" id="horizStepper">
                                                        <li class="step active">
                                                            ...
                                                            <div class="step-content">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="max-length browser-default error"
                                                                            data-placeholder="Type *" name="type"
                                                                            data-error=".errorTxt6" required>
                                                                            <option style="color:#9e9e9e;">Choose a Type</option>
                                                                            <option value="typ1">Type_1</option>
                                                                            <option value="typ2">Type_2</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="max-length browser-default error"
                                                                            data-placeholder="Faculty *" name="faculty"
                                                                            data-error=".errorTxt6" required>
                                                                            <option style="color:#9e9e9e;">Choose a Faculty</option>
                                                                            <option value="Fac1">Faculty_1</option>
                                                                            <option value="Fac2">Faculty_2</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                <div class="input-field col m4 s12">
                                                                <select class="max-length browser-default error"
                                                                            data-placeholder="Program *" name="program"
                                                                            data-error=".errorTxt6" required>
                                                                            <option style="color:#9e9e9e;">Choose a Program</option>
                                                                            <option value="Pro1">Program_1</option>
                                                                            <option value="Pro2">Program_2</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="input-field col m4 s12">
                                                                        <select class="max-length browser-default error"
                                                                            data-placeholder="Session *" name="session"
                                                                            data-error=".errorTxt6" required>
                                                                            <option style="color:#9e9e9e;">Choose a Session</option>
                                                                            <option value="">Session_1</option>
                                                                            <option value="">Session_2</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="input-field col m4 s12">
                                                                    <select class="max-length browser-default error"
                                                                            data-placeholder="Semester *" name="semester"
                                                                            data-error=".errorTxt6" required>
                                                                            <option style="color:#9e9e9e;">Choose a Semester</option>
                                                                            <option value="all">All</option>
                                                                            <option value="">Semester_1</option>
                                                                            <option value="">Semester_2</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="input-field col m4 s12">

                                                                         <select class="max-length browser-default error"
                                                                            data-placeholder="Section *" name="section"
                                                                            data-error=".errorTxt6" required>
                                                                            <option style="color:#9e9e9e;">Choose a Section</option>
                                                                            <option value="">Section_1</option>
                                                                            <option value="">Section_2</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="input-field col m4 s12">
                                                                        <label for="contentdate">Date *</label>
                                                                        <input type="text" name="contdate"
                                                                            class="datepicker validate" id="contdate"
                                                                            required="">
                                                                    </div>
                                                                    <div class="input-field col m4 s12">
                                                                        <label for="SourceURL">Source URL </label>
                                                                        <input type="text" class="validate"
                                                                            name="sourceurl" id="sourceurl" required>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="input-field col m4 s12">
