    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
        ...
        <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out"
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li class="active"><a class="active" href="../study_materials/assignment_list.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                <span data-i18n="Assignment List">Assignment List</span>
                            </a>
                        </li>
                        <li><a href="../study_materials/content_list.php"><i
                                    class="material-icons">radio_button_unchecked</i>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="input-field col m4 s12">
                                                                            <select
                                                                                ...
                                                                                data-placeholder="Faculty *"
                                                                                name="faculty" data-error=".errorTxt6"
                                                                                required>
                                                                                <option style="color:#9e9e9e;" value=""
                                                                                    disabled selected hidden>Choose a
                                                                                    Faculty</option>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="input-field col m4 s12">
                                                                            <select
                                                                                ...
                                                                                name="program" data-error=".errorTxt6"
                                                                                required>
                                                                                <option style="color:#9e9e9e;">Choose a
                                                                                    Program</option>
                                                                        ...
                                                                        <div class="input-field col m4 s12">
                                                                            <select
                                                                                ...
                                                                                name="session" data-error=".errorTxt6"
                                                                                required>
                                                                                <option style="color:#9e9e9e;">Choose a
                                                                                    Session</option>
                                                                        ...
                                                                        <div class="input-field col m4 s12">
                                                                            <select
                                                                                ...
                                                                                name="semester" data-error=".errorTxt6"
                                                                                required>
                                                                                <option style="color:#9e9e9e;">Choose a
                                                                                    Semester</option>
                                                                        ...
                                                                        <div class="input-field col m4 s12">
                                                                            ...
                                                                            <select
                                                                                ...
                                                                                name="section" data-error=".errorTxt6"
                                                                                required>
                                                                                <option style="color:#9e9e9e;">Choose a
                                                                                    Section</option>
                                                                        ...
                                                                        <div class="input-field col m4 s12">
                                                                            <select
                                                                                ...
                                                                                <option style="color:#9e9e9e;">Choose a
                                                                                    Course</option>
                                                                                <option value="all">All</option>
                                                                                <option value="">Course_1</option>
                                                                                <option value="">Course_2</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="input-field col m4 s12">
                                                                            <label for="totmarks">Total Marks * </label>
                                                                            <input type="text" class="validate"
                                                                                name="totmarks" id="totmarks" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="input-field col m4 s12">
                                                                            <label for="substart">Submission Start Date
                                                                                *</label>
                                                                            <input type="text" name="substart"
                                                                                class="datepicker validate"
                                                                                id="substart" required="">
                                                                        </div>
                                                                        <div class="input-field col m4 s12">
                                                                            <label for="substart">Submission End Date
                                                                                *</label>
                                                                            <input type="text" name="substart"
                                                                                class="datepicker validate" id="subend"
                                                                                required="">
                                                                        </div>
                                                                        <div class="input-field col m4 s12">
