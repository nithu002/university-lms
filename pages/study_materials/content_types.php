            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"
                            ...
                            <div class="collapsible-body">
                                <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                                    ...
                                    <li class="active"><a class="active" href="../study_materials/content_types.php"><i
                                                class="material-icons">radio_button_unchecked</i>
                                                ...
                                                <div class="col s4">
                                                    ...
                                                    <div id="modal1" class="modal col s4">
                                                        <div class="modal-content">
                                                            <blockquote>
                                                                <h5 class="indigo-text">Edit Status Type</h5>
                                                            </blockquote>
                                                            <div class="row">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" name=""
                                                                    class="btn waves-effect waves-light gradient-45deg-green-teal btn-flat">Update</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card-content px-36">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col m6 s12 pull-m6">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Content Type List</h5>
                                                    </blockquote>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="users-list-datatable" class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td></td>
                                                                    <td>2</td>
                                                                    <td>Study Material Type2</td>
                                                                    <td></td>
                                                                    <td><span class="chip red lighten-5">
                                                                            <span class="red-text">Inactive</span></td>
                                                                    <td></td>
                                                                    <td> <a class=" modal-trigger button8 button3 "
                                                                            href="#modal1"><i
                                                                                class="material-icons center"
                                        ...
                                        <form method="post" action="">
                                            <div class="card-content">
                                                ...
                                                <div id="cards-extended">
                                                    <blockquote>
                                                        <h5 class="indigo-text">Create Content Type</h5>
                                                    </blockquote>
                                                </div>
                                                <div class="row">
                                                    <div class="col s1.5 offset-s0"><span class="flow-text">
                                                            <div class="">
                                                                <a href="content_types.php"
